...
import com.kpi.springboot_laba_2.form.CreateCategoryForm;
...
public class CategoryController {
    ...
    public ResponseEntity<Category> createCategory(@RequestBody @Valid CreateCategoryForm categoryForm, BindingResult bindingResult){
            ...
            int id = categoryService.createCategoryUniqueId();
            Category newCategory = new Category(id, categoryForm.getName(), categoryForm.getParentId());
