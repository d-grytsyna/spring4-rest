package com.kpi.springboot_laba_2.restcontroller;

import com.kpi.springboot_laba_2.dto.ProductDTO;
import com.kpi.springboot_laba_2.entity.Product;
import com.kpi.springboot_laba_2.exception.info.ErrorInfo;
...
public class ProductController {
    ...
    public ResponseEntity<Product> createProduct(@RequestBody @Valid CreateProductForm createProductForm, BindingResult bindingResult){
        ...
        int id = productService.createProductUniqueId();
        Product newProduct = new Product(id, createProductForm.getName(), createProductForm.getDescription(), createProductForm.getPrice(), createProductForm.getCategoryId());
